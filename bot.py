...
TELEGRAM_TOKEN = os.getenv("7969184483:AAEHfgUFiUmeWIJBpAV6KxjJl7okF02Ud2I")  # Pegaremos do Render
...
def webhook():
    ...
    if message.lower().startswith("/start"):
        text = f"Olá @{username}, seja bem-vindo! Aqui está seu link de compra: https://seu-link-kiwify"
    elif message.lower().startswith("/vincular"):
        text = "Por favor, me envie o seu e-mail da compra para associarmos ao seu usuário."
    else:
        text = "Mensagem recebida! Em breve você poderá usar comandos mais avançados."
